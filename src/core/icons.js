...
const P = {
  ...
  coin: '<circle cx="12" cy="12" r="8.5"/><path d="M14.4 9.2a3 3 0 0 0-2.4-1.1c-1.5 0-2.6.9-2.6 2s.9 1.7 2.6 2c1.7.3 2.6.9 2.6 2s-1.1 2-2.6 2a3 3 0 0 1-2.4-1.1"/><path d="M12 6.4v1.7M12 15.9v1.7"/>',
  dice: '<rect x="4" y="4" width="16" height="16" rx="3.5"/><circle cx="9" cy="9" r="1.1" fill="currentColor" stroke="none"/><circle cx="15" cy="15" r="1.1" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.1" fill="currentColor" stroke="none"/>',
  bolt: '<path d="M13 2.5 4.5 13.5H11l-1 8 8.5-11H12l1-8Z"/>',
  trophy: '<path d="M8 4h8v5a4 4 0 0 1-8 0V4Z"/><path d="M8 5.5H5.5A2.5 2.5 0 0 0 5.8 10 4 4 0 0 0 8 11M16 5.5h2.5a2.5 2.5 0 0 1-.3 4.5A4 4 0 0 1 16 11"/><path d="M12 13v3.5M8.5 20.5h7M9.8 20.5c0-1.7.9-2.6 2.2-2.6s2.2.9 2.2 2.6"/>',
